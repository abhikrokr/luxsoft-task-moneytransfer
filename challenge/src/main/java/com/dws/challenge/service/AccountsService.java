...
public class AccountsService {
  ...
  public synchronized void transferMoney(MoneyTransfer moneyTransfer) {
    ...
    if(fromAcc.getBalance().compareTo(moneyTransfer.getAmount()) < 0){
      ...
      fromAcc.setBalance(fromAcc.getBalance().subtract(moneyTransfer.getAmount()));
      updateAccount(fromAcc);
    }

    tooAcc.setBalance(tooAcc.getBalance().add(moneyTransfer.getAmount()));
